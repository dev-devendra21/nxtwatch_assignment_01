...
export const NavBar = styled.div`
  ...
  background-color: ${props =>
    props.isdark === 'true' ? '#212121' : '#ffffff'};
  height: 15vh;
`
...
export const LogOutButton = styled.button`
  border-width: 1px;
  border-style: solid;
  border-color: ${props => (props.isdark === 'true' ? '#BABABA' : '#378ff3')};
  padding: 10px;
  width: 80px;
  font-weight: 600;
  color: ${props => (props.isdark === 'true' ? '#BABABA' : '#378ff3')};
  background-color: transparent;
  border-radius: 5px;
  cursor: pointer;
  display: none;
...
export const ModalMessage = styled.p`
  font-size: 16px;
  color: ${props => (props.isdark === 'true' ? '#CECFD1' : '#164278')};
  text-align: center;
`
